...
完整操作与指令说明见仓库文档：[docs/guide.md](https://github.com/shaohui-jin/git-skills/blob/master/docs/guide.md)。

## 发布到 Cursor 市场（维护者）

完整流程（账号 / 生成 Token / ①设 Token → ②create-namespace → ③verify-pat → ④publish:ovsx、排错）见：
