...
> **范围**：本 Skill 只覆盖**只读分析**（分支图 + 合并预演）。一键解决冲突 / 推送 / 申请 MR 属于扩展能力，见 [docs/project-design.md](../../docs/project-design.md)，Agent **不要**为了预演去 `merge` / `checkout` / `push`。
...
- 项目整体设计（含扩展一键解决 / MR 与全部指令表）：[docs/project-design.md](../../docs/project-design.md)
